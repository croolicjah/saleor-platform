...
VATLAYER_ACCESS_KEY = os.environ.get("VATLAYER_ACCESS_KEY", "ec94e477d3da7170c9e1f79bde1be65f")
...
AVATAX_COMPANY_NAME = os.environ.get("AVATAX_COMPANY_NAME", "POLGER-KIDO")
